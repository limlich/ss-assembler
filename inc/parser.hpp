...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    PLUS = 267,                    // PLUS
    MUL = 268,                     // MUL
    SBR_OPEN = 269,                // SBR_OPEN
    SBR_CLOSE = 270,               // SBR_CLOSE
    NEWLINE = 271                  // NEWLINE
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        TOKEN_IDENT = 3,                         // IDENT
        TOKEN_INT_10 = 4,                        // INT_10
        TOKEN_INT_16 = 5,                        // INT_16
        TOKEN_REG = 6,                           // REG
        TOKEN_DOLLAR = 7,                        // DOLLAR
        TOKEN_PERCENT = 8,                       // PERCENT
        TOKEN_COLON = 9,                         // COLON
        TOKEN_COMMA = 10,                        // COMMA
        TOKEN_PERIOD = 11,                       // PERIOD
        TOKEN_PLUS = 12,                         // PLUS
        TOKEN_MUL = 13,                          // MUL
        TOKEN_SBR_OPEN = 14,                     // SBR_OPEN
        TOKEN_SBR_CLOSE = 15,                    // SBR_CLOSE
        TOKEN_NEWLINE = 16,                      // NEWLINE
        TOKEN_YYACCEPT = 17,                     // $accept
        TOKEN_program = 18,                      // program
        TOKEN_line = 19,                         // line
        TOKEN_instr = 20,                        // instr
        TOKEN_instr_arg = 21,                    // instr_arg
        TOKEN_dir = 22,                          // dir
...
switch (yykind)
    ...
    Parser (yy::Lexer& lexer_yyarg, Assembler& assembler_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_INT_10 (std::string v, location_type l)
      {
        return symbol_type (token::INT_10, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_INT_10 (const std::string& v, const location_type& l)
      {
        return symbol_type (token::INT_10, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_INT_16 (std::string v, location_type l)
      {
        return symbol_type (token::INT_16, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_INT_16 (const std::string& v, const location_type& l)
      {
        return symbol_type (token::INT_16, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::REG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::REG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_SBR_OPEN (location_type l)
      {
        return symbol_type (token::SBR_OPEN, std::move (l));
      }
#else
      static
      symbol_type
      make_SBR_OPEN (const location_type& l)
      {
        return symbol_type (token::SBR_OPEN, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_SBR_CLOSE (location_type l)
      {
        return symbol_type (token::SBR_CLOSE, std::move (l));
      }
#else
      static
      symbol_type
      make_SBR_CLOSE (const location_type& l)
      {
        return symbol_type (token::SBR_CLOSE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
  ...
  private:
    ...
    struct by_state
    {
      ...
      /// \a symbol_kind::TOKEN_YYEMPTY when empty.
      symbol_kind_type kind () const YY_NOEXCEPT;
  ...
  Parser::yytranslate_ (int t)
  {
    ...
    if (t <= 0)
      return symbol_kind::TOKEN_YYEOF;
    else if (t <= code_max)
      return YY_CAST (symbol_kind_type, translate_table[t]);
    else
      return symbol_kind::TOKEN_YYUNDEF;
  }
  ...
  {
    return this->kind () == symbol_kind::TOKEN_YYEMPTY;
  }
  ...
  Parser::by_kind::by_kind ()
    : kind_ (symbol_kind::TOKEN_YYEMPTY)
  {}
